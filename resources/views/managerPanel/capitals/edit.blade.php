    ...
    <main class="container">
        ...
        <div class="brudcrumbs my-3">
            <ul>
                ...
                <li>
                    <a href="#">ویرایش نام کلانشهر {{ $capital->name }}</a>
                </li>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('manager.capitals.update',$capital->id) }}" method="POST" class="w-lg-50 mb-4">
                                @csrf
                                @method('put')
