            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-lg-11">
                        ...
                        <div class="col-md-6">
                            ...
                            <form action="{{ route(auth()->user()->role->title.'.capitals.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="Ostan" type="number" class="form-control" value="{{ old('Ostan') }}">
                                    
                                </div><br>
                                <div class="input-group">
                                    <label for="exampleInputFile">تصویر کلانشهر</label>
                                    <input class="form-control-file" name="imageUrl" type="file">
                  
                                    <p class="help-block">نمایش در صفحه اصلی</p>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon"> جمعیت کلانشهر  </span>
                                    <input name="city_people_amount" type="text" class="form-control" value="{{ old('city_people_amount') }}">
                                    
                                </div><br>
                                <div class="input-group">
                                    <span class="input-group-addon">  مناطق دیدنی  </span>
<textarea rows="4" name="city_places" type="text" class="form-control">{{ old('city_places') }}</textarea>
                                    
                                </div><br>
                                <div class="input-group">
                                    <span class="input-group-addon">  آدرس   </span>
                                    <input name="city_address" type="text" class="form-control" value="{{ old('city_address') }}">
                                    
                                </div><br>
                                <div class="input-group">
                                    <span class="input-group-addon">  تلفن   </span>
                                    <input name="city_tel" type="text" class="form-control" value="{{ old('city_tel') }}">
                                    
                                </div><br>
                                <div class="input-group">
                                    <span class="input-group-addon">  وبسایت   </span>
                                    <input name="city_website" type="text" class="form-control" value="{{ old('city_website') }}">
                                    
                                </div><br>
                                <div class="input-group">
                                    <span class="input-group-addon">  آدرس اینترنتی وبسایت   </span>
                                    <input name="city_website_url" type="text" class="form-control text-left"
                                    placeholder="http:\\www.sample.com" value="{{ old('city_website_url') }}">
                                    
                                </div><br>
                                  <div class="box-footer">
                                <button class="btn btn-success pull-right">ایجاد کلانشهر جدید</button>
                                  </div>
                            </form>
                            </div>
                            </div>
